...
const navigation = [
  ...
  { name: "Bereikbaarheid", href: "/accessibility", current: false },
];
...
export default function Home() {
  return (
    <>
      ...
      <div className="h-[calc(100svh-65px)] overflow-y-scroll sm:snap-y sm:snap-mandatory">
        <section className="sm:snap-start h-[calc(100svh-65px)] flex items-center justify-center">
        ...
        <section className="sm:snap-start h-[calc(100svh-65px)] flex items-center justify-center mt-32 sm:mt-auto">
